...
alias mount-gpfs='sudo mount -t cifs -o user=I3\\rhow,domain=I3,iocharset=utf8,file_mode=0777,dir_mode=0777,sec=ntlmv2 //data.i3.local/1 ~/mounts/gpfs'
alias mount-jungfrau='sudo mount.cifs //documents.i3.local/jungfrau ~/mounts/jungfrau/ -o user=I3\\rhow,domain=I3,iocharset=utf8,file_mode=0777,dir_mode=0777,sec=ntlmv2'
